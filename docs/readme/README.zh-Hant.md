...
> [!NOTE]
> **授權變更：** 從 v1.0.0 起，OxideTerm 已將授權從 **PolyForm Noncommercial 1.0.0** 變更為 **GPL-3.0（GNU 通用公共授權條款 v3.0）**。這意味著 OxideTerm 現在是完全開源的——您可以在 GPL-3.0 授權條款下自由使用、修改和散布。我們主動做這個轉換，就是為了不玩帶非商用陷阱或競業禁止附加條款的「開源 cosplay」，而是把使用者、fork、再散布者和商業使用者的 copyleft 自由說清楚。詳見 [LICENSE](../../LICENSE) 檔案。
