...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.1.23-blue" alt="版本">
...
> [!WARNING]
> **维护声明：** OxideTerm 由独立开发者以**尽力而为**的方式维护。**Bug 修复优先处理；功能请求可能不会被实现。** 如果您希望某个功能落地，欢迎提交 PR。提交 Issue 并不意味着维护者有义务实现它。感谢您的理解与支持。
