...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.1.23-blue" alt="バージョン">
...
> [!WARNING]
> **メンテナンスに関するお知らせ：** OxideTerm は個人開発者により**ベストエフォート**で維持されています。**バグ修正が優先されます。機能リクエストには対応できない場合があります。** 機能の実装をご希望の場合は、PR の提出を歓迎します。Issue の提出はメンテナーに実装義務を課すものではありません。ご理解とご支援に感謝いたします。
