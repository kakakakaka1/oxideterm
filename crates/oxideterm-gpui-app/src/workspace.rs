...
use oxideterm_connection_monitor::{
    ...
    FilesystemEntrySeverity, FilesystemFilter, GpuDevice, GpuSamplingTask, GpuSnapshot,
    GpuSnapshotStatus, GpuUpdate, HostToolActionOutcome, LogCommandCapability, LogPreset,
    MetricsSource, MonitorListRow, MonitorMetricKind, MonitorSectionKind, MonitorValueLevel,
