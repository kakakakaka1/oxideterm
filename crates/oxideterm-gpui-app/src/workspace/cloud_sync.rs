...
pub(super) struct CloudSyncViewState {
    ...
    pub(super) select_frozen_anchor: Option<OverlayAnchor>,
    pub(super) select_presence: oxideterm_gpui_ui::motion::ExitPresence,
...
impl CloudSyncViewState {
    fn new(settings: &CloudSyncSettings) -> Self {
        ...
        Self {
            ...
            select_frozen_anchor: None,
            select_presence: oxideterm_gpui_ui::motion::ExitPresence::visible(),
            focused_select: None,
