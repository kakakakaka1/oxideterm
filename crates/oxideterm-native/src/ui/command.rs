...
pub(crate) fn command(tokens: &ThemeTokens) -> Div {
    div()
        .flex()
        .h_full()
        .w_full()
...
pub(crate) fn command_input(tokens: &ThemeTokens, input: impl IntoElement) -> Div {
    div()
        .flex()
        .items_center()
        .flex_1()
...
pub(crate) fn command_list(tokens: &ThemeTokens) -> Div {
    div()
        .max_h(px(tokens.metrics.ui_command_list_max_height))
        .overflow_hidden()
}

pub(crate) fn command_empty(tokens: &ThemeTokens, label: impl Into<String>) -> Div {
    div()
...
pub(crate) fn command_group(tokens: &ThemeTokens, heading: Option<String>) -> Div {
    div()
        .overflow_hidden()
...
pub(crate) fn command_item(tokens: &ThemeTokens, selected: bool, label: impl IntoElement) -> Div {
    div()
        .relative()
        .flex()
        .cursor_pointer()
...
pub(crate) fn command_separator(tokens: &ThemeTokens) -> Div {
    div()
...
pub(crate) fn command_shortcut(tokens: &ThemeTokens, shortcut: impl Into<String>) -> Div {
    div()
        .ml_auto()
        .flex_none()
        .text_size(px(tokens.metrics.ui_text_xs))
